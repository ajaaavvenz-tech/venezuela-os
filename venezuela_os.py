...
""" + RESET)
    ...
    print(CYAN + "[ SYSTEM INITIALIZED :: VIPER DOWN ACTIVE...]" + RESET)

    print(ai_color() + """
==========================================
(👋 OLAA ) I'M OS VIPER SYSTEM
==========================================
""" + RESET)

    print(YELLOW + """
Script by   : VENZBJIRR.
Version     : 7.3 (VIPER DOWN)
Codename    : VIPER-X
System      : Termux CLI
""" + RESET)
...
╔══════════════════════════════════════════╗
║        ⚡ SYSTEM STATUS LIVE             ║
║  Time : {datetime.now().strftime('%H:%M:%S')}  |  VIPER DOWN ACTIVE    ║
╚══════════════════════════════════════════╝
""" + RESET)
...
def main():
    clear()
    logo()
    loading("VIPER V7.3 BOOTING")

    while True:
        kali_header("VIPER DOWN BY VENZ")
        print(GREEN + """
help   -> masuk fitur
info   -> system info
clear  -> clear
